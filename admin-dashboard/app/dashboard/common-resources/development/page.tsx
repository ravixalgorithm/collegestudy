...
import { Plus, Edit, Trash2, Search, Download, Star, Eye, FileText, Globe, TrendingUp } from "lucide-react";
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage development topics and resources</p>
          </div>
            ...
            <Dialog open={showTopicModal} onOpenChange={setShowTopicModal}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    {editingTopic ? "Update the topic details" : "Create a new development topic"}
                  </DialogDescription>
                </DialogHeader>
            ...
            <Dialog open={showResourceModal} onOpenChange={setShowResourceModal}>
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    {editingResource ? "Update the resource details" : "Upload a new development resource"}
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  <Input
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage development topics and their resources</CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  {selectedTopic === "all" ? "All development resources" : `Resources for ${topics.find(t => t.id === selectedTopic)?.title}`}
                </CardDescription>
              </div>
              <div className="flex gap-2">
