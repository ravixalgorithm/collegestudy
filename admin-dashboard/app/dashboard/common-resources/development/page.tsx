...
import { Plus, Edit, Trash2, Search, Download, Star, FileText, Monitor, TrendingUp, Code } from "lucide-react";
...
export default function DevelopmentNotesManagement() {
  const [topics, setTopics] = useState<DevelopmentTopic[]>([]);
  const [notes, setNotes] = useState<DevelopmentNote[]>([]);
  const [selectedTopic, setSelectedTopic] = useState<string>("all");
  const [loading, setLoading] = useState(true);
  const [searchTerm, setSearchTerm] = useState("");
  const [showTopicDialog, setShowTopicDialog] = useState(false);
  const [editingTopic, setEditingTopic] = useState<DevelopmentTopic | null>(null);
  ...
  const fetchTopics = async () => {
    try {
      ...
      toast.error("Failed to load development topics");
    }
  };
  ...
  const handleCreateTopic = async () => {
    try {
      ...
      toast.success("Development topic created successfully");
  ...
  const openEditTopic = (topic: DevelopmentTopic) => {
  ...
  const handleCreateNote = async () => {
    try {
      ...
      toast.success("Development note created successfully");
  ...
  const openEditNote = (note: DevelopmentNote) => {
    setEditingNote(note);
    setNoteForm({
      ...
      <div className="space-y-8">
        ...
        <div className="border-b border-gray-200 pb-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-2">Manage web, mobile, and backend development resources</p>
            </div>
            <div className="flex gap-3">
              <Dialog open={showTopicDialog} onOpenChange={setShowTopicDialog}>
                ...
                >
                  <DialogHeader>
                    <DialogTitle>{editingTopic ? "Edit Topic" : "Create New Development Topic"}</DialogTitle>
                    <DialogDescription>
                      {editingTopic ? "Update topic information" : "Add a new topic to Development category"}
                    </DialogDescription>
                  </DialogHeader>
              ...
              <Dialog open={showNoteDialog} onOpenChange={setShowNoteDialog}>
                ...
                >
                  <DialogHeader>
                    <DialogTitle>{editingNote ? "Edit Note" : "Add New Development Note"}</DialogTitle>
                    <DialogDescription>
                      {editingNote ? "Update note information" : "Add a new note to Development resources"}
                    </DialogDescription>
                  </DialogHeader>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage topics within the Development category</CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardHeader>
            <div className="flex justify-between items-center">
              <div>
                ...
                <CardDescription>Manage notes and resources for Development topics</CardDescription>
              </div>
              <div className="flex gap-3">
