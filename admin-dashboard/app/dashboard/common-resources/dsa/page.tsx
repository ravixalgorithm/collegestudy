...
export default function DSAResourcesPage() {
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage DSA topics and resources</p>
          </div>
            ...
            <Dialog open={showTopicModal} onOpenChange={setShowTopicModal}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    {editingTopic ? "Update the topic details" : "Create a new DSA topic"}
                  </DialogDescription>
                </DialogHeader>
            ...
            <Dialog open={showResourceModal} onOpenChange={setShowResourceModal}>
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    {editingResource ? "Update the resource details" : "Upload a new DSA resource"}
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  <Input
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage DSA topics and their resources</CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  {selectedTopic === "all" ? "All DSA resources" : `Resources for ${topics.find(t => t.id === selectedTopic)?.title}`}
                </CardDescription>
              </div>
              <div className="flex gap-2">
