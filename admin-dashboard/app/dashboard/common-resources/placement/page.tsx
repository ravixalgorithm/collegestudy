...
import { Plus, Edit, Trash2, Search, Download, Star, FileText, Target, TrendingUp } from "lucide-react";
...
export default function PlacementNotesManagement() {
  ...
  const [editingTopic, setEditingTopic] = useState<PlacementTopic | null>(null);
  ...
  const fetchTopics = async () => {
    try {
      ...
      toast.error("Failed to load Placement topics");
    }
  };
  ...
  const handleCreateTopic = async () => {
    try {
      ...
      toast.success("Placement topic created successfully");
  ...
  const openEditTopic = (topic: PlacementTopic) => {
  ...
  const handleCreateNote = async () => {
    try {
      ...
      toast.success("Placement note created successfully");
  ...
  const openEditNote = (note: PlacementNote) => {
    setEditingNote(note);
    setNoteForm({
      ...
      <div className="space-y-8">
          ...
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
                ...
                Placement Notes Management
              </h1>
              <p className="text-gray-600 mt-2">Manage placement preparation and career guidance resources</p>
            </div>
            <div className="flex gap-3">
              <Dialog open={showTopicDialog} onOpenChange={setShowTopicDialog}>
                ...
                >
                  <DialogHeader>
                    <DialogTitle>{editingTopic ? "Edit Topic" : "Create New Placement Topic"}</DialogTitle>
                    <DialogDescription>
                      {editingTopic ? "Update topic information" : "Add a new topic to Placement category"}
                    </DialogDescription>
                  </DialogHeader>
              ...
              <Dialog open={showNoteDialog} onOpenChange={setShowNoteDialog}>
                ...
                >
                  <DialogHeader>
                    <DialogTitle>{editingNote ? "Edit Note" : "Add New Placement Note"}</DialogTitle>
                    <DialogDescription>
                      {editingNote ? "Update note information" : "Add a new note to Placement resources"}
                    </DialogDescription>
                  </DialogHeader>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage topics within the Placement category</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <div className="flex justify-between items-center">
              <div>
                <CardTitle>Placement Notes</CardTitle>
                <CardDescription>Manage notes and resources for Placement topics</CardDescription>
              </div>
              <div className="flex gap-3">
